...
/********** Image 3 **********/
		...
		/********** Image 4 **********/
				...
				$wp_customize->add_section( 'seos_photography_section_4' , array(
					'title'       => __( 'Image 4', 'seos-photography' ),
					'panel' => 'seos_photography_homa_image_panel',
					'description' => __( 'Select IMG. The image will be activated in your home page.', 'seos-photography' ),
					'priority'		=> 3,
				) );
				...
				$wp_customize->add_control( 'hide_img_4', array(
					'section'   => 'seos_photography_section_4',
					'label'     => 'Hide Default Image 4',
					'type'      => 'checkbox'
					 )
				 );

				$wp_customize->add_setting( 'seos_photography_img4', array (
					'sanitize_callback' => 'esc_url_raw',
				) );
				...
				$wp_customize->add_control(
					new WP_Customize_Image_Control(
					$wp_customize,
					'seos_photography_img4',
					array(
						'label'      => __( 'Image:', 'seos-photography' ),
						'description' => __( 'Load IMG from your media:', 'seos-photography' ),
						'section'    => 'seos_photography_section_4',
						'settings'   => 'seos_photography_img4',
					) ) );

				$wp_customize->add_setting( 'seos_photography_title4', array (
					'sanitize_callback' => 'sanitize_text_field',
				) );

				$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'seos_photography_title4', array(
					'label'    => __( 'Image Title:', 'seos-photography' ),
					'section'  => 'seos_photography_section_4',
					'description' => __( 'The title of your Image. Will be activated in your home page:', 'seos-photography' ),
					'settings' => 'seos_photography_title4',
					'type' => 'text',
				) ) );

				$wp_customize->add_setting( 'seos_photography_text4', array (
					'sanitize_callback' => 'sanitize_text_field',
				) );

				$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'seos_photography_text4', array(
					'label'    => __( 'Image Text:', 'seos-photography' ),
					'section'  => 'seos_photography_section_4',
					'description' => __( 'Content of your Image. Will be activated in your home page:', 'seos-photography' ),
					'settings' => 'seos_photography_text4',
					'type' => 'textarea',
				) ) );

				$wp_customize->add_setting( 'seos_photography_url4', array (
					'sanitize_callback' => 'esc_url_raw',
					'default' => '#',
				) );

				$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'seos_photography_url4', array(
					'label'    => __( 'Image URL:', 'seos-photography' ),
					'section'  => 'seos_photography_section_4',
					'description' => __( 'Copy and paste the URL from your media:', 'seos-photography' ),
					'settings' => 'seos_photography_url4',
				) ) );
